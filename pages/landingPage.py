...
Douring this proect I learned a lot. 
One of the main things I learned was that marticles the zise of 1 meter can't go very far up, meaning that something else has to be in play for the smoke cloud to rise that far.
...
I wanted to also add GPU support for bigger datasets, but due to lack of knowledge, I was unable to do so, however, if I do end up knowing how, I will update this code to support it.
